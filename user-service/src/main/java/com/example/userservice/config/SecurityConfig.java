...
public class SecurityConfig {
    ...
    public SecurityConfig(UserDetailsService userDetailsService, JwtRequestFilter jwtRequestFilter, CustomOAuth2UserService customOAuth2UserService) {
        ...
        this.customOAuth2UserService = customOAuth2UserService; // Inject the custom OAuth2 service
    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .requestMatchers("/api/users/login", "/api/users/register", "/oauth2/**", "/api/users/google-login").permitAll()  // Allow Google OAuth and other public endpoints
                ...
                .and()
                .and()
                .addFilterBefore(jwtRequestFilter, UsernamePasswordAuthenticationFilter.class);  // Add JWT filter for custom login
